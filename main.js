...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   homeDiv: () => (/* binding */ homeDiv),\n/* harmony export */   homeSection: () => (/* binding */ homeSection)\n/* harmony export */ });\n/* harmony import */ var _utils_createSection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/createSection */ \"./src/content/utils/createSection.js\");\n/* harmony import */ var _utils_pubsub__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/pubsub */ \"./src/content/utils/pubsub.js\");\n/* harmony import */ var _utils_createTask__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/createTask */ \"./src/content/utils/createTask.js\");\n\n\n\n\nconst homeDiv = document.querySelector(\".home\");\n\nconst defaultHomeTasksArr = [\n  (0,_utils_createTask__WEBPACK_IMPORTED_MODULE_2__.createTask)(\"Title1\", \"Change this\", \"2024-07-11\", \"medium\", false),\n  (0,_utils_createTask__WEBPACK_IMPORTED_MODULE_2__.createTask)(\"Title2\", \"Change this\", \"2024-07-11\", \"medium\", false),\n  (0,_utils_createTask__WEBPACK_IMPORTED_MODULE_2__.createTask)(\"Title3\", \"Change this\", \"2024-07-11\", \"medium\", false),\n  (0,_utils_createTask__WEBPACK_IMPORTED_MODULE_2__.createTask)(\"Title4\", \"Change this\", \"2024-07-11\", \"medium\", false),\n];\nconst homeSection = (0,_utils_createSection__WEBPACK_IMPORTED_MODULE_0__.createSection)(\"home\", defaultHomeTasksArr);\n\n_utils_pubsub__WEBPACK_IMPORTED_MODULE_1__.events.on(homeSection.getSectionId(), homeSection.addTaskToSectionArray);\n\n\n\n\n//# sourceURL=webpack://newtodoproject/./src/content/home.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addProject: () => (/* binding */ addProject)\n/* harmony export */ });\n/* harmony import */ var _dom_createProjectDom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../dom/createProjectDom */ \"./src/dom/createProjectDom.js\");\n/* harmony import */ var _utils_createSection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/createSection */ \"./src/content/utils/createSection.js\");\n/* harmony import */ var _section__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./section */ \"./src/content/section.js\");\n/* harmony import */ var _utils_pubsub__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/pubsub */ \"./src/content/utils/pubsub.js\");\n\n\n\n\n\nfunction addProject() {\n  const hiddenDiv = document.querySelector(\"#hiddenDiv\");\n  const addProjectSVG = document.querySelector(\"#addProjectSVG\");\n\n  addProjectSVG.addEventListener(\"click\", showHiddenDiv);\n  hiddenDiv.addEventListener(\"keydown\", handleKeyDown);\n  document.addEventListener(\"click\", handleClickOutside);\n\n  function showHiddenDiv() {\n    hiddenDiv.style.display = \"block\";\n    hiddenDiv.textContent = \"\";\n    hiddenDiv.setAttribute(\"contenteditable\", \"true\");\n    hiddenDiv.focus();\n  }\n\n  function handleKeyDown(e) {\n    if (e.key === \"Enter\") {\n      e.preventDefault();\n      confirmAndSubmit();\n    }\n  }\n\n  function handleClickOutside(e) {\n    if (\n      hiddenDiv.style.display === \"block\" &&\n      !hiddenDiv.contains(e.target) &&\n      !addProjectSVG.contains(e.target)\n    ) {\n      confirmAndSubmit();\n    }\n  }\n\n  function confirmAndSubmit() {\n    const projectName = hiddenDiv.textContent.trim();\n    if (\n      projectName &&\n      confirm(\"Are you sure you want to add the project name?\")\n    ) {\n      const projectIdAttr = (0,_dom_createProjectDom__WEBPACK_IMPORTED_MODULE_0__.createProjectDom)(projectName);\n      const projectDomIdEl = document.querySelector(`#${projectIdAttr}`);\n\n      const projectSection = (0,_utils_createSection__WEBPACK_IMPORTED_MODULE_1__.createSection)(projectName);\n      _utils_pubsub__WEBPACK_IMPORTED_MODULE_3__.events.on(\n        projectSection.getSectionId(),\n        projectSection.addTaskToSectionArray\n      );\n\n      projectDomIdEl.addEventListener(\"click\", () => {\n        _section__WEBPACK_IMPORTED_MODULE_2__.section.changeCurrentSection(projectSection);\n        _section__WEBPACK_IMPORTED_MODULE_2__.section.render();\n      });\n    }\n    hiddenDiv.setAttribute(\"contenteditable\", \"false\");\n    hiddenDiv.style.display = \"none\";\n  }\n}\n\n\n\n\n//# sourceURL=webpack://newtodoproject/./src/content/projects.js?");
...
/***/ "./src/dom/createProjectDom.js":
/*!*************************************!*\
  !*** ./src/dom/createProjectDom.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   createProjectDom: () => (/* binding */ createProjectDom)\n/* harmony export */ });\n/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! uuid */ \"./node_modules/uuid/dist/esm-browser/v4.js\");\n\n\nfunction createProjectDom(titleName) {\n  const parentEl = document.querySelector(\"#projectsParent\");\n\n  const div = document.createElement(\"div\");\n  div.classList.add(\"project\");\n  parentEl.appendChild(div);\n\n  const id = `project-${(0,uuid__WEBPACK_IMPORTED_MODULE_0__[\"default\"])()}`;\n  const span = document.createElement(\"span\");\n  span.setAttribute(\"id\", id);\n  span.classList.add(\"projectTitle\");\n  span.textContent = titleName;\n  div.appendChild(span);\n\n  return id;\n}\n\n\n\n\n//# sourceURL=webpack://newtodoproject/./src/dom/createProjectDom.js?");
